 ...
 * URL: www.redux.com
*/
package upgrad.movies.api.controller.ext;

import static upgrad.movies.api.data.ResourceConstants.HEADER_ACCESS_TOKEN;
import static upgrad.movies.api.data.ResourceConstants.HEADER_LOCATION;
